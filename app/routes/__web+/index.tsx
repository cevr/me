  ...
  return (
    ...
    >
      ...
      >
        <motion.img
          variants={listItem}
          className="mx-auto aspect-square w-full max-w-64 rounded-md"
          src="/images/me.jpg"
          alt="Portrait of me"
        />
        ...
        >
          <h1 className="text-4xl text-neutral-50 md:text-6xl">
            Hi, I'm Cristian.
          </h1>
          <div>
            <p className="text-lg leading-10">
              I'm a product engineer that pursues excellence.
            </p>

            <p className="text-lg leading-10">
              I just like to be proud of my work.
            </p>
          </div>
        </motion.div>
      </motion.section>
      ...
      >
        <h2 className="text-2xl text-neutral-50 md:text-4xl">Experiments</h2>
        ...
        >
          {apps.map((app) => (
            <motion.li
              variants={listItem}
              key={app.href}
              className="text-lg duration-200 hover:text-salmon-500"
            >
              <Link
                prefetch="intent"
                to={app.href}
      ...
      <motion.section
        variants={listItem}
        className="flex h-full flex-col gap-5 md:gap-2 md:p-0"
      >
        <motion.h2
          variants={listItem}
          className="text-2xl text-neutral-50 md:text-4xl"
        >
          Projects
        </motion.h2>
        <motion.ul
        ...
        >
          {data.projects.map((project) => (
            <motion.li
              ...
              className="group text-xl duration-200 hover:text-salmon-500"
            >
              <a
                target="_blank"
