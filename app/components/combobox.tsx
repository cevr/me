...
export const ComboBox = <T extends object>({ className, ...props }: ReactAria.ComboBoxProps<T>) => {
  return <ReactAria.ComboBox className={cn("group w-full", className)} {...props} />;
};
...
export const ComboBoxPopover = ({ className, ...props }: ReactAria.PopoverProps) => {
  return (
    <ReactAria.Popover
      className={cn(
...
export const ComboBoxContent = <T extends object>({ className, ...props }: ReactAria.ListBoxProps<T>) => {
  return <ReactAria.ListBox className={cn("outline-none", className)} {...props} />;
};

export interface ListBoxItemProps extends ReactAria.ListBoxItemProps {}

export const ComboBoxItem = ({ className, children, ...props }: ListBoxItemProps) => {
  return (
...
export const ComboBoxButton = ({ className, ...props }: ReactAria.ButtonProps) => {
