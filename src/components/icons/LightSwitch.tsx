...
function LightSwitch(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      ></path>
      <path d="M168.18,185H16.82A16.84,16.84,0,0,1,0,168.18V16.82A16.84,16.84,0,0,1,16.82,0H168.18A16.84,16.84,0,0,1,185,16.82V168.18A16.84,16.84,0,0,1,168.18,185ZM16.82,5A11.83,11.83,0,0,0,5,16.82V168.18A11.83,11.83,0,0,0,16.82,180H168.18A11.83,11.83,0,0,0,180,168.18V16.82A11.83,11.83,0,0,0,168.18,5H16.82Z"></path>
    </svg>
  );
}
